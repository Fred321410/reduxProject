...
export function reducer(
  state = initialState,
  action: BillActions | CollectionActions
): State {
  switch (action.type) {
    case BillActionTypes.SearchComplete:
...
export const getSelectedId = (state: State) => state.selectedBillId;
